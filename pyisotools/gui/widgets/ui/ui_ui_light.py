...
################################################################################
## Form generated from reading UI file 'ui_light.ui'
##
...
"}")
        ...
        self.title_bar.setStyleSheet(u"background-color: #bbb;")
...
"}")
        ...
        self.content_bar.setStyleSheet(u"border-radius: 4px")
...
"")
        ...
        self.color_vis.setMinimumSize(QSize(0, 30))
...
"")
        ...
        self.lastcolor_vis.setMinimumSize(QSize(0, 30))
