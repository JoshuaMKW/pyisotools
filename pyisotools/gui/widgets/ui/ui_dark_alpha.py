...
#
# Created by: qtpy UI code generator 5.15.0
#
...
class Ui_ColorPicker():
    def setupUi(self, ColorPicker: QtWidgets.QMainWindow):
        ...
        ColorPicker.setMinimumSize(QtCore.QSize(440, 320))
        ColorPicker.setMaximumSize(QtCore.QSize(440, 320))
        ...
        self.color_picker = QtWidgets.QPushButton(self.content_bar)
        pickerImg = QtGui.QImage(
            str(resource_path("gui/icons/color_picker.png")))
        for x in range(pickerImg.width()):
            for y in range(pickerImg.height()):
                pcolor = pickerImg.pixelColor(x, y)
                if pcolor.alpha() > 0:
                    n_color = QtGui.QColor("#aaa")
                    n_color.setAlpha(pcolor.alpha())
                    pickerImg.setPixelColor(x, y, n_color)
        pickerPix = QtGui.QPixmap(pickerImg)
        pickerPix.scaled(20, 20, QtCore.Qt.KeepAspectRatio)
        self.color_picker.setIcon(QtGui.QIcon(pickerPix))
        self.color_picker.setGeometry(QtCore.QRect(260, 0, 26, 200))
        self.color_picker.setMinimumSize(QtCore.QSize(20, 200))
        self.color_picker.setStyleSheet("background-color: none;")
        self.hue.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.hue.setFrameShadow(QtWidgets.QFrame.Raised)
