...
from pyisotools.gui.qdarktheme.qtpy.QtCore import QDir, Qt, Slot
from pyisotools.gui.qdarktheme.qtpy.QtGui import QAction, QActionGroup, QFont, QIcon
from pyisotools.gui.qdarktheme.qtpy.QtWidgets import (
    QApplication,
    QColorDialog,
    QFileDialog,
    QFontDialog,
...
from pyisotools.gui.qdarktheme.util import get_qdarktheme_root_path
from pyisotools.gui.qdarktheme.widget_gallery.ui.dock_ui import DockUI
from pyisotools.gui.qdarktheme.widget_gallery.ui.frame_ui import FrameUI
from pyisotools.gui.qdarktheme.widget_gallery.ui.widgets_ui import WidgetsUI
...
class _WidgetGalleryUI:
    def setup_ui(self, main_win: QMainWindow) -> None:
        ...
        self.action_open_folder = QAction(
            QIcon("icons:folder_open_24dp.svg"), "Open folder dialog")
        self.action_open_color_dialog = QAction(
            QIcon("icons:palette_24dp.svg"), "Open color dialog")
        ...
        self.actions_theme = [QAction(theme, main_win)
        ...
        tool_btn_settings.setPopupMode(
...
class WidgetGallery(QMainWindow):
    ...
    def __init__(self) -> None:
        ...
        super().__init__()
        QDir.addSearchPath(
            "icons", f"{get_qdarktheme_root_path().as_posix()}/widget_gallery/svg")
        ...
        self._ui.action_open_color_dialog.triggered.connect(
            lambda: QColorDialog.getColor(
                parent=self, options=QColorDialog.DontUseNativeDialog)
        )
        self._ui.action_open_font_dialog.triggered.connect(
            lambda: QFontDialog.getFont(
                QFont(), parent=self, options=QFontDialog.DontUseNativeDialog)
        )
